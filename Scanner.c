	...
	while (1) { /* endless loop broken by token returns it will generate a warning */
		...
		*/
		...
		default: // general case
			...
			if (*finalStateTable[state] == NULL)//error catching
			{
				printf("State %d is not a final state",state );
				exit(1);
			}
			else
			{
...
/*    [A-z],[0-9],    _,    #,   \",    .,    (       \n	EOF
	   L(0), D(1), U(2), H(3), Q(4), P(5), B1X(6),  N(7)    EOF(8)*/
...
/*
* Added function to identify float literals
*/
...
/*
* Added function to identify variable name literal
*/
